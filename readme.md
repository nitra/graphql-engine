...
```bash
docker pull hasura/graphql-engine:v2.8.3.debian.amd64
docker tag hasura/graphql-engine:v2.8.3.debian.amd64 eu.gcr.io/abinbev-ua/graphql-engine:v2.8.3
docker push eu.gcr.io/abinbev-ua/graphql-engine:v2.8.3
```
